...
<div class="page-content">
        ...
        <div class="single-slider-boxed text-center owl-no-dots owl-carousel">
            <div class="card rounded-l shadow-l" data-card-height="320">
                ...
                <div class="card-bg owl-lazy" data-src="images/pictures/17m.jpg">
                </div>
            </div>
            <div class="card rounded-l shadow-l" data-card-height="320">
                <div class="card-bottom">
                ...
                <div class="card-overlay bg-gradient-fade"></div>
                <div class="card-bg owl-lazy" data-src="images/pictures/8m.jpg">
                </div>
            </div>
            <div class="card rounded-l shadow-l" data-card-height="320">
                <div class="card-bottom">
                ...
                <div class="card-overlay bg-gradient-fade"></div>
                <div class="card-bg owl-lazy" data-src="images/pictures/14m.jpg">
                </div>
            </div>
        </div>
        ...
        <div class="double-slider text-center owl-carousel owl-no-dots">
            <div class="item bg-theme rounded-m shadow-m">
                ...
                <p class="line-height-s font-11">
                     Built with care and <br>every detail in mind</p>
            </div>
            <div class="item bg-theme rounded-m shadow-m">
                ...
                <p class="line-height-s font-11">
                     Just add it to your <br>Home Screen</p>
            </div>
            <div class="item bg-theme rounded-m shadow-m">
                ...
                <p class="line-height-s font-11">
                     Light &amp; Dark and <br>Auto Dark Detection</p>
            </div>
            <div class="item bg-theme rounded-m shadow-m">
                ...
                <p class="line-height-s font-11">
                     Built for you and me <br>copy and paste code.</p>
            </div>
        </div>
            ...
            <div class="card-body">
                ...
                <div class="card card-style ml-0 mr-0 bg-white">
                    <div class="row mt-3 pt-1 mb-3">
                        <div class="col-6">
                            <i class="float-left ml-3 mr-3" data-feather="globe" data-feather-line="1" data-feather-size="35" data-feather-color="blue2-dark" data-feather-bg="blue2-fade-light"></i>
                            <h5 class="color-black float-left font-13 font-500 line-height-s pb-3 mb-3">Mobile<br>Website</h5>
                        </div>
                        <div class="col-6">
                            <i class="float-left ml-3 mr-3" data-feather="smartphone" data-feather-line="1" data-feather-size="35" data-feather-color="dark2-dark" data-feather-bg="dark2-fade-light"></i>
                            <h5 class="color-black float-left font-13 font-500 line-height-s pb-3 mb-3">Mobile<br>PWA</h5>
                        </div>
                        <div class="col-6">
                            <i class="float-left ml-3 mr-3" data-feather="user" data-feather-line="1" data-feather-size="35" data-feather-color="brown2-dark" data-feather-bg="brown2-fade-light"></i>
                            <h5 class="color-black float-left font-13 font-500 line-height-s">Mobile<br>Website</h5>
                        </div>
                        <div class="col-6">
                            <i class="float-left ml-3 mr-3" data-feather="box" data-feather-line="1" data-feather-size="35" data-feather-color="green1-dark" data-feather-bg="green1-fade-light"></i>
        ...
        <div class="card card-style">
            ...
            <div class="user-list-slider owl-carousel mt-3 mb-n1">
                <div class="icon-user">
                    <img data-src="images/avatars/1s.png" width="55" height="55" class="rounded-xl owl-lazy shadow-l bg-gradient-blue2" src="images/products-azures21">
                    <p>
                        Jane
                    </p>
                </div>
                <div class="icon-user">
                    <img data-src="images/avatars/2s.png" width="55" height="55" class="rounded-xl owl-lazy shadow-l bg-gradient-red2" src="images/products-azures21">
                    <p>
                        Craig
                    </p>
                </div>
                <div class="icon-user">
                    <img data-src="images/avatars/1s.png" width="55" height="55" class="rounded-xl owl-lazy shadow-l bg-gradient-green1" src="images/products-azures21">
                    <p>
                        Jane
                    </p>
                </div>
                <div class="icon-user">
                    <img data-src="images/avatars/2s.png" width="55" height="55" class="rounded-xl owl-lazy shadow-l bg-gradient-brown1" src="images/products-azures21">
                    <p>
                        Craig
                    </p>
                </div>
        ...
        <div class="double-slider owl-carousel owl-no-dots text-center">
            <div class="item bg-theme pb-3 rounded-m shadow-l">
                ...
                <p class="mb-3 pl-2 pr-2 pt-2 font-12">Classic, elegant and powerful. A best seller.</p>
            ...
            <div class="item bg-theme pb-3 rounded-m shadow-l">
                ...
                <p class="mb-3 pl-2 pr-2 pt-2 font-12">A best seller, elegant multi use design.</p>
                <a href="#" class="btn btn-xs bg-highlight btn-center-xs rounded-s shadow-s text-uppercase font-900">View</a>
            </div>
            <div class="item bg-theme pb-3 rounded-m shadow-l">
                ...
                <p class="mb-3 pl-2 pr-2 pt-2 font-12">Modern sidebars and a very intuitive interface.</p>
                <a href="#" class="btn btn-xs bg-highlight btn-center-xs rounded-s shadow-s text-uppercase font-900">View</a>
            </div>
        </div>
        ...
        <div class="card card-style text-center">
            <div class="content pb-2">
                <h1>
                <i data-feather="gift" data-feather-line="1" data-feather-size="55" data-feather-color="red2-dark" data-feather-bg="red2-fade-dark"></i>
                </h1>
